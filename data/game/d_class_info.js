                ...
                "jobs":[
                    {
                        ...
                        "spec2":2,
                        "spec3":3,
                        "explanation":"여러가지 속성을 사용해 조종하는 일반적인 마법사.<br>그러나 상급마법의 경이로움을 부정할 수 없다.<br>아군뒤쪽에서 스킬을 쓰며 싸우는 케릭이다.<br>유지기를 잘 사용할줄 아시는분께 추천한다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"파이어볼",
                    ...
                    },
                    {
                        ...
                        "spec2":3,
                        "spec3":1,
                        "explanation":"마법사계열이지만 전투에 능하여 전사계열 방식으로 싸우는 클래스<br>마법이 더해져서 환상적인 싸움방식을 보여준다<br>아군에게 마나를 줄수 있다.<br>스킬들을 잘 조합한다면 극딜러가 될수 있다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"파이어볼",
                            ...
                            },
                            {
                                "command":"A+A",
                                "name":"마법의 오로라",
                                "explanation":"파티원들의 마나를 100씩 증가시켜준다.",
                                "type":"유틸기"
                            },
                            {
                                "command":"O",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":2,
                        "spec3":3,
                        "explanation":"트랩을 설치하여 적에게 데미지를 주는 클래스입니다.<br>다소 특이한 싸움패턴이지만 잘 사용한다면 효율이좋은 클래스.<br>잘못 사용한다면 팀킬이 될수 있어 한편으로는 위험한 클래스.<br>이 클래스의 궁극기는 특이하게도 보스를 속박시키는 기술이다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"트랩 발동 !",
                    ...
                    },
                    {
                        ...
                        "spec2":2,
                        "spec3":3,
                        "explanation":"완벽한 백발백중의 저격을 하여 상대에게 치명적 타격을 주는 클래스<br>원거리형 전투를 하며 지원사격을 하면 전투가 수월하다.<br>특히나 궁극기는 적들에게 매우 치명적인 타격을 줄수있다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"헤드샷",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":2,
                        "spec3":3,
                        "explanation":"아군을 치료하며 , 여러가지 버프로 싸우기 편하게 해주는 클래스<br>강한 적도 프리스트가 버프를 걸어주면 훨씬 수월해진다<br>히든스킬을 사용해 직접 싸우기도 한다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"매지컬 실드",
                    ...
                    },
                    {
                        ...
                        "spec2":2,
                        "spec3":3,
                        "explanation":"다양한 치료법으로 아군을 치료하여 든든한 클래스<br>때로는 자신을 희생하여 팀을 소생시킬 수 있다",
                        "skills":[
                            {
                                "command":"S",
                                "name":"의료장비 공급",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":3,
                        "spec3":4,
                        "explanation":"다양한 무기를 이용하여 타격을 주는 클래스<br>가히 강력한 무기들은 경이로운 파괴력을 보여준다<br>궁극기는 탱커와 딜러의 특성을 동시에 가지고 있다",
                        "skills":[
                            {
                                "command":"S",
                                "name":"지원사격 MG-43",
                            ...
                            },
                            {
                                "command":"A",
                                "name":"레이저 머신건",
                                "explanation":"강력한 레이저 머신건을 꺼내서 발사한다.",
                                "type":"공격형"
                            },
                            {
                                "command":"O",
                                "name":"로즈러너",
                                "explanation":"자신의 동료들을 부른다.",
                                "type":"소환형"
                            }
                        ]
                    },
                    {
                        ...
                        "spec2":3,
                        "spec3":5,
                        "explanation":"정찰등의 다양한 기동성으로 팀에 도움이 되는 클래스<br>파괴력역시 다른 클래스에 밀리지않는다<br>어려운 유지기를 가지고있는 클래스중 하나이다",
                        "skills":[
                            {
                                "command":"S",
                                "name":"지원사격 MG-43",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":5,
                        "spec3":5,
                        "explanation":"정식닌자 훈련을 받은 파괴력과 기동성의 클래스<br>분신술,수리검등을 무기로 쓰지만 여전히 자신의 내구력은 약하다<br>하지만 분신들에 자신의 영혼을 담으면 내구력은 넘쳐흐른다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"강탈",
                    ...
                    },
                    {
                        ...
                        "spec2":2,
                        "spec3":5,
                        "explanation":"정식암살자 훈련을 받은 극의 파괴력과 기동성의 클래스<br>은신,암살등의 잠입형 스킬을 사용한다<br>자신밖에 모르고 싸우는 클래스이다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"강탈",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":5,
                        "spec3":3,
                        "explanation":"마법적으로 싸우는 데빌 클레스. 그의 마법은 아무도 버티지 못한다.<br>그 와 맞선다면 조심해야 할 것이다.<br>불사의 몸을 이용해 모든것을 파괴시킬수 있다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"재생력",
                    ...
                    },
                    {
                        ...
                        "spec2":3,
                        "spec3":3,
                        "explanation":"오직 파괴만을 사라온 존재. 그가 지나가면<br>모든 것은 파괴되고 질서는 무너지며 혼란만을 가져 올 것이다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"재생력",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":2,
                        "spec3":5,
                        "explanation":"수많은 로봇을 만들어 전투에 임하는 클래스.<br>자유자재로 컨트롤하며 최상위로봇을 소환할 수도 있다<br>",
                        "skills":[
                            {
                                "command":"S",
                                "name":"연구비 지원",
                        ...
                        "buildings":[
                            {
                                "command":"TBS",
                                "usage":"메카닉 유닛을 하나 소환합니다."
                            },
                            {
                                "command":"TBC",
                                "usage":"메카닉 유닛을 둘 소환합니다."
                            },
                            {
                                "command":"TBU",
                    ...
                    },
                    {
                        ...
                        "spec2":2,
                        "spec3":3,
                        "explanation":"폭발계열 로봇을 만들어 적에게 큰피해를 주는 클래스<br>그 파괴력은 누구도 따라가지 못한다.<br>그러나 폭발이다 보니 아군까지 피해를 입을 수 있다",
                        "skills":[
                            {
                                "command":"S",
                                "name":"연구비 지원",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":1,
                        "spec3":2,
                        "explanation":"정령들을 폭발시켜 주변의 흐름을 붕괴시키는 클래스<br>정령은 이세계의 생명체가 아니라서 차원을 일그러뜨린다<br>종수유지기로 한때 강력했던 클래스.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"맹독충",
                    ...
                    },
                    {
                        ...
                        "spec2":2,
                        "spec3":3,
                        "explanation":"모든 정령들을 소환하여 싸움에 임하는 클래스<br>상급이상계열의 정령들은 최고의 전투력을 보여준다",
                        "skills":[
                            {
                                "command":"S",
                                "name":"하급정령 소환",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":3,
                        "spec3":2,
                        "explanation":"평소 건물의 틀을 완전히 깨버린 클래스<br>더 이상 그의 건물은 이제 평소건물이 아니다<br>여러가지 버프로 승리를 쉽게 가져온다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"건축비 지원",
                    ...
                    },
                    {
                        ...
                        "spec2":7,
                        "spec3":2,
                        "explanation":"건물을 건설하여 싸우는 전형적인 빌더 클래스<br>내구력만큼은 그 누구도 따라가지 못한다.<br>마나만 충분하다면 유지력도 뛰어나다",
                        "skills":[
                            {
                                "command":"S",
                                "name":"도발",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":2,
                        "spec3":2,
                        "explanation":"적에게 저주를 걸어서 상태이상을 부여하는 클래스<br>사신의 힘을 빌려 파괴력또한 좋은 편이다.<br>하지만 사신에게 영혼을 팔아 뭔가 불안하다",
                        "skills":[
                            {
                                "command":"S",
                                "name":"어둠의 제물",
                    ...
                    },
                    {
                        ...
                        "spec2":3,
                        "spec3":2,
                        "explanation":"모든 생명체를 컨트롤 할 수 있는 클래스.<br>심지어 죽음까지 다루고 있다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"어둠의 제물",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":2,
                        "spec3":4,
                        "explanation":"판타지엔 버서커가 있다면 동양에는 자객이 있다.<br>그는 도둑처럼 돈을 원하기 보단 살인을 가장 좋아한다.<br>다만 내구력이 약한편이고 오로지 근접형이다",
                        "skills":[
                            {
                                "command":"S",
                                "name":"회피",
                    ...
                    },
                    {
                        ...
                        "spec2":2,
                        "spec3":3,
                        "explanation":"검술의 무한한 경지의 자리 최고에 오른 자.<br>다수의 공격을 하는 것은 물론 검기라는 것을 사용하여<br>장거리로도 적을 말살하는 클래스이다.<br>하지만 파괴력은 결코무시하지 못한다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"회피",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":3,
                        "spec3":2,
                        "explanation":"하늘의 직접적인 가호를 받으며 싸우는 클래스.<br>신의 영역으로 싸우는 그에게 적들은 무릎을 꿇는다",
                        "skills":[
                            {
                                "command":"S",
                                "name":"하늘의 축복",
                            ...
                            },
                            {
                                "command":"AA",
                                "name":"얽힌 진실",
                                "explanation":"가장 왼쪽의 크루세이더로 이동하고 모든 환영을 새로 소환합니다. 쿨타임을 갱신합니다.",
                                "type":"유틸기"
                            },
                            {
                                "command":"A",
                    ...
                    },
                    {
                        ...
                        "spec2":4,
                        "spec3":3,
                        "explanation":"세상의 모든 빛을 조종하여 싸우는 클래스<br>하지만 전투능력은 빛보다 빠르고 강하다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"하늘의 축복",
                ...
                "jobs":[
                    {
                        ...
                        "spec2":1,
                        "spec3":5,
                        "explanation":"클래스중 최고의 기동성을 보여주는 클래스<br>신의 컨트롤만이 이 클래스의 능력을 극대화시킬 수 있다.",
                        "skills":[
                            {
                                "command":"S",
                                "name":"배터링",
                    ...
                    },
                    {
                        ...
                        "spec2":2,
                        "spec3":3,
                        "explanation":"직접싸우기보다 공중병력으로 지원사격이 강점인 클래스.<br>공군의 파괴력은 위대하다",
                        "skills":[
                            {
                                "command":"S",
                                "name":"배터링",
