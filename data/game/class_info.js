                ...
                "jobs":[
                    ...
                    },
                    {
                        ...
                        "skills":[
                            ...
                            {
                                "command":"O+O+O+O",
                                "name":"구원<span class='DPTEXT_08'>(1회용)</span>",
                    ...
                    },
                    {
                        ...
                        "skills":[
                            ...
                            },
                            {
                                "command":"파이어골램+C",
                                "name":"반응형 폭발물 제조",
                                "explanation":"주위의 파이어골램을 하나 회수, 개조하여 반응형 폭발물을 제조합니다. (최대 5기)",
                                "type":"유틸기"
                            },
                            {
                                "command":"A",
                                "name":"반응형 폭발물 투하",
                                "explanation":"극도로 민감하고 강력한 폭발물을 하나 주변 적에게 내보냅니다.",
                                "type":"공격형"
                            },
                            {
                                "command":"O",
                                "name":"폭탄핵분열",
                                "explanation":"가장 왼쪽의 파이어골렘을 핵분열시킵니다. 연쇄폭발이 가능합니다.",
                                "type":"공격형"
                            }
                        ],
                        "buildings":[
                    ...
                    },
                    {
                        ...
                        "skills":[
                            ...
                            },
                            {
                                "command":"C",
                                "name":"중급정령-매직골렘",
                                "explanation":"하급정령이 중급정령인 매직골렘으로 승급합니다. (최대 6기)",
                                "type":"소환형"
                            },
                            {
                                "command":"A",
                                "name":"지도자-제탈피스",
                                "explanation":"제탈피스를 가진 자만이 비로소 진정한 지도자다.<br>제탈피스가 존재하는 동안 자신과 매직골렘들의 쉴드가 일정량 유지됩니다.",
                                "type":"소환형"
                            },
                            {
                                "command":"제탈피스+A",
                                "name":"지도자의 힘",
                                "explanation":"제탈피스 자신과 주위의 정령을 회복시키고 50초동안 유지되는 쉴드량이 100%로 증가합니다. (쿨타임 60초)<br>제탈피스의 마나가 245로 설정되지만 10초후 마나를 모두 잃습니다.",
                                "type":"유틸기"
                            },
                            {
                                "command":"O",
                            ...
                            },
                            {
                                "command":"정령왕+O",
                                "name":"정령왕의 출격",
                                "explanation":"정령왕 아타락시아가 소환수들을 이끈다.",
                                "type":"공격형"
                            }
                        ]
                    }
                ...
                "skills":[
                    {
                        "command":"P",
                        "name":"무감각",
                        "explanation":"(현재 스테이지)*10만큼의 쉴드가 유지됩니다.<br>스킬을 사용하는 동안 유지되는 쉴드량이 100% 증가합니다.",
                        "type":"회복형"
                    },
                    {
                        "command":"P",
